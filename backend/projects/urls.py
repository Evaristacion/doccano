...
from .views.project import CloneProject, ProjectDetail, ProjectList, PerspectiveViewSet
...
urlpatterns = [
    ...
    path(route="projects/<int:project_id>/perspectives", view=PerspectiveViewSet.as_view({'get': 'list', 'post': 'create'}), name="perspective_list"),
    path(route="projects/<int:project_id>/perspectives/<int:pk>", view=PerspectiveViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name="perspective_detail")
]
